...
- приватный список
- поиск TMDB
- поиск внутри личного списка
- добавление
- watched
- удаление
- фильтрация по статусу: все / не просмотрено / просмотрено
- фильтрация по типу: все типы / фильмы / сериалы
- сортировка по дате добавления: сначала новые / сначала старые
- пагинация списка по 10 элементов
